...
const mysql_schema_print_types_1 = require("@databases/mysql-schema-print-types");
...
async function run(cwd, args) {
    ...
    const { connectionStringEnvironmentVariable, types: { directory, ...types }, } = params.configFilename
        ? (0, mysql_config_1.readMySqlConfigSync)((0, path_1.resolve)(cwd, params.configFilename))
        : (0, mysql_config_1.getMySqlConfigSync)(cwd);
    ...
    const connection = (0, mysql_schema_introspect_1.connect)({ connectionString: database, poolSize: 1 });
    let schema;
    try {
        schema = await (0, mysql_schema_introspect_1.default)(connection, { schemaName: params.schemaName });
    }
    finally {
    ...
    await (0, mysql_schema_print_types_1.writeSchema)(schema, (0, path_1.resolve)(cwd, (_b = params.directory) !== null && _b !== void 0 ? _b : directory), types);
    return 0;
}
exports.default = run;
